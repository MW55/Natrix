...
| ampli_corr        | fdr                                                                               | Specifies the correction method for Fisher's excat test.                                                                                                                                                                                      |
...
| db_path           | database/silva.db                                                                 | Path to the database file against which the BLAST should be carried out, at the moment only the SILVA database will be automatically downloaded, other databases have to be downloaded and configurated manually.                             |
